          ...
          child: Column(
            children: <Widget>[
              ...
              TextFormField(           //email field
                decoration: textInputDecoration.copyWith(hintText: 'email'), //this is from different category
              ...
              TextFormField(         //password field
                decoration: textInputDecoration.copyWith(hintText: 'password'), //this is from different category
              ...
              RaisedButton( //register button
                  ...
                  onPressed: () async {
                    if(_formKey.currentState.validate()){
                      ...
                      if(result == null) {
                        setState(() {
                          error = 'this is an existing account , please sign up';
                          loading =false;
                        });
                      }
                    }
